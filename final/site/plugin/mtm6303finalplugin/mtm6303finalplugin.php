...
Description: This is a test Plugin created for MTM6303 Finals.<br> Shortcodes available : <br> [mtm6303finalplugin]
Version: 1.0.0
Author: Yifan Chen
Author URI: http://algonquincollege.com
License: GPLv2 or later
Text Domain: mtm63030slider
*/
/**
...
{
    if (!is_admin()) {
        wp_enqueue_style('slider', plugins_url('assets/slider.css', __FILE__), [], '1.0.0', false);
        wp_enqueue_script('slider-js', plugins_url('/assets/slider.js', __FILE__), [], '1.0.0', true);
    }
}
 ...
 * Build Pluign Slider
 */
function mtm63030plugin_build_slider($images = true)
{
...
<div class="slideshow-container">
    ...
    <div class="mySlides">
            ...
            if ($images && !empty($the_image_url)) {
                echo '<img style="width:100%" src="' . $the_image_url[0] . '">';
            } ?>
            <div class="text">
 ...
 */
function mtm63030plugin_func($atts)
{
    return mtm63030plugin_build_slider();
}
// With Images
add_shortcode('mtm6303finalplugin', 'mtm63030plugin_func');
?>