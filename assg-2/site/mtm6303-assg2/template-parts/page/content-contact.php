...
<div class="section-container no-padding">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <img class="img-responsive" src="<?php echo get_stylesheet_directory_uri();?>/img/contact.jpg">
            </div>
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-5 col-md-offset-1">
                        ...
                        <div>
                            <p>To apply for a job with our team, please feel free to send us your Linkedin
                                profile link
